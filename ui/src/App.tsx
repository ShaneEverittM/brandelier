        ...
        <div className="app">
            ...
            <header className="topbar">
                ...
                <nav className="modebar" role="tablist">
                    <button role="tab" aria-pressed={mode === 'manual'} onClick={() => setMode('manual')}>Manual
                    </button>
                    <button role="tab" aria-pressed={mode === 'wave'} onClick={() => setMode('wave')}>Wave</button>
                    <button role="tab" aria-pressed={mode === 'precise'} onClick={() => setMode('precise')}>Precise
                    </button>
                </nav>
          ...
          <span className="connection">
            ...
            Live · ws://chandelier.local
                    ...
                    {isPlaying ? (
                        ...
                        <button className="transport-btn primary" onClick={() => {
                            setMode('wave');
                            setIsPlaying(true);
                        }}>
                            <svg viewBox="0 0 12 12" fill="currentColor">
